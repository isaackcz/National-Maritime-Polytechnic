            ...
            <Box sx={{ 
                ...
                <MuiTelInput 
                    ...
                    onChange={(value, info) => {
                        ...
                        if (digits.length <= 12) { // +63 (2 digits) + 11 digits = 13
...
const ContactPersonStep = ({ logic, errors, onFieldTouch, clearErrorIfValid }) => (
    <Box>
        ...
        <InfoCard>
            {/* Name, Relationship, Address - 3 columns responsive */}
            <Box sx={{ 
                display: 'grid',
                gridTemplateColumns: 'repeat(auto-fit, minmax(220px, 1fr))',
                gap: 2,
            ...
            <Box sx={{ 
                ...
                <MuiTelInput 
                    ...
                    onChange={(value, info) => {
                        const digits = value.replace(/\D/g, '');
                        if (digits.length <= 12) {
                            logic.setCPmobileNumber1(digits);
                ...
                <MuiTelInput 
                    ...
                    onChange={(value, info) => {
                        ...
                        const digits = value.replace(/\D/g, '');
                        if (digits.length <= 12) { // +63 (2 digits) + 11 digits = 13
                            logic.setCPmobileNumber2(digits);
...
const DocumentsStep = ({ logic, errors, onFieldTouch, clearErrorIfValid }) => (
    <Box>
        ...
        {(errors.signatureFile || errors.IDPicture || errors.SRNFile || errors.seamansBook || errors.lastDisembarkation || errors.licenseFile) && (
            <Box sx={{ mb: 2, p: 1.5, backgroundColor: '#ffebee', borderRadius: 1, border: '1px solid #f44336' }}>
                <Typography sx={{ fontSize: '13px', color: '#d32f2f', fontWeight: 500 }}>
                    <i className="fas fa-exclamation-circle mr-2"></i>
            ...
            <Box sx={{ 
                ...
                <DragDropFileInput 
                    ...
                    onChange={(e) => {
                        ...
                        clearErrorIfValid('IDPicture', file, { IDPicture: file });
                    }} 
                    accept="image/*"
                ...
                <DragDropFileInput 
                    ...
                    onChange={(e) => {
                        ...
                        const file = e.target ? e.target.files?.[0] : e.files?.[0];
                        clearErrorIfValid('SRNFile', file, { SRNFile: file });
                    }} 
                    accept="image/*"
                ...
                <DragDropFileInput 
                    ...
                    onChange={(e) => {
                        ...
                        const file = e.target ? e.target.files?.[0] : e.files?.[0];
                        clearErrorIfValid('seamansBook', file, { seamansBook: file });
                    }}
            ...
            <Box sx={{ 
                ...
                <DragDropFileInput 
                    ...
                    onChange={(e) => {
                        ...
                        const file = e.target ? e.target.files?.[0] : e.files?.[0];
                        clearErrorIfValid('licenseFile', file, { licenseFile: file });
                    }}
