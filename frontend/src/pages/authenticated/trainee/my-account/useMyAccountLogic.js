...
const useMyAccountLogic = () => {
        ...
        try {
            ...
            if(response.status === 200) {
                ...
                if (additionalInfo.general_info) {
                    ...
                    setBirthdate(genInfo.birthdate || '');
    ...
    const SubmitFormPersonal = async (e) => {
        ...
        try {
            ...
            // Only append files if they are actual File objects (new uploads)
            // Don't append empty strings or existing filenames without file objects
            if (signatureFile && signatureFile instanceof File) {
                ...
                console.log("ℹ️ Signature file exists but not uploading new one:", signatureFileName);
            }
            ...
            if (IDPicture && IDPicture instanceof File) {
                ...
                console.log("ℹ️ ID picture file exists but not uploading new one:", IDPictureFileName);
            }
            ...
            if (SRNFile && SRNFile instanceof File) {
                ...
                console.log("ℹ️ SRN file exists but not uploading new one:", SRNFileName);
            }
            ...
            if (seamansBook && seamansBook instanceof File) {
                ...
                console.log("ℹ️ Sea service file exists but not uploading new one:", seamansBookFileName);
            }
            ...
            if (LastDisembarkation && LastDisembarkation instanceof File) {
                ...
                console.log("ℹ️ Last disembarkation file exists but not uploading new one:", lastDisembarkationFileName);
            }
            ...
            if (licenseFile && licenseFile instanceof File) {
                ...
                console.log("ℹ️ License file exists but not uploading new one:", licenseFileName);
            }
