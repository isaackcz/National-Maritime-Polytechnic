...
const AdminDormitoryInvoices = () => {
    ...
    const PaidPendingInvoices =[
        { label: 'Pending Invoices', value: pendingInvoicesCount, color: '#ffbf00ff' },
        { label: 'Paid Invoices', value: paidInvoicesCount, color: '#2eff5eff' },
    ];
    const settings = {
        margin: { right: 5 },
        width: 200,
    ...
    const ActiveInactiveTenants = tenants
                                    ...
                                    <div className="card-body p-3">
                                        <div className="d-flex justify-content-between">
                                            <div>
                                                ...
                                                <span className='fw-bold'>Paid Invoices</span>
                                            </div>
                                            <div className="align-self-center">
                                    ...
                                    <div className="card-body p-3">
                                        <div className="d-flex justify-content-between">
                                            <div>
                                                ...
                                                <span className='fw-bold'>Pending Invoices</span>
                                            </div>
                                            <div className="align-self-center">
                            ...
                            {/* <div className="col-md-2 col-sm-6">
                                <div className="card bg-success text-white shadow-sm">
                                    <div className="card-body p-3">
                                        <div className="d-flex justify-content-between">
                                            <div>
                                                <h4 className="mb-0">{stats.activeTenants}</h4>
                                                <span className='fw-bold'>Active Tenants</span>
                                            </div>
                                            <div className="align-self-center">
                            ...
                            <div className="col-md-2 col-sm-6">
                                <div className="card bg-info text-white shadow-sm">
                                    <div className="card-body p-3">
                                        <div className="d-flex justify-content-between">
                                            <div>
                                                <h4 className="mb-0">{stats.pendingTenants}</h4>
                                                <span className='fw-bold'>Pending Tenants</span>
                                            </div>
                                            <div className="align-self-center">
                                                <i className="fas fa-user-clock fa-2x opacity-50"></i>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                            ...
                            {/* <div className="col-md-2 col-sm-6">
                                <div className="card bg-secondary text-white shadow-sm">
                                    <div className="card-body p-3">
                                        <div className="d-flex justify-content-between">
                                            <div>
                                                <h4 className="mb-0">{dormitories.length}</h4>
