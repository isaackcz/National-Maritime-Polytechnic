                                ...
                                <div className='text-right mt-4'>
                                    <div className='row'>
                                        <div className='col-6 pr-0'>
                                            <button type="button" className="btn btn-block btn-default text--fontPos13--xW8hS" data-dismiss="modal">Cancel</button>
                                        </div>

                                        <div className='col-6 pl-0'>
                                            <button type="submit" className={`btn btn-block btn-danger elevation-1 text--fontPos13--xW8hS ml-2`}>
                                                Delete
                                            </button>
                                        </div>
                                    </div>
