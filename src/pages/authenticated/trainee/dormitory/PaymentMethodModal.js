                ...
                <div className="modal-content border-0 shadow-lg">
                    ...
                    <div className="modal-body" style={{ padding: '2rem' }}>
                        ...
                        <div className="alert alert-info border-0 mb-4" style={{ backgroundColor: '#e7f3ff' }}>
                            ...
                            <small style={{ fontSize: '13px', color: '#0078d4' }}>Your request will be submitted for admin approval. A payment link will be sent to your email upon approval.</small>
                        </div>
